...
namespace Weedwacker.GameServer.Systems.Player
{
    internal class MapMarksManager
    {
        ...
        public async Task Teleport(MarkMapReq markMap)
        {
            ...
            await Owner.World.TransferPlayerToSceneAsync(Owner, Enums.EnterReason.TransPoint, markMap.Mark.SceneId == (uint)Owner.SceneId ? EnterType.Goto : EnterType.Jump, (int)markMap.Mark.SceneId, pos, useDefaultBornPosition: false);
        }
    }
}
