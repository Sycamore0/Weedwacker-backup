...
namespace Weedwacker.Shared.Network.Proto {
    ...
    static GCGOperationReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Weedwacker.Shared.Network.Proto.GCGOperation), global::Weedwacker.Shared.Network.Proto.GCGOperation.Parser, new[]{ "OpRedraw", "OpSelectOnStage", "OpReroll", "OpAttack", "OpPass", "OpPlayCard", "OpReboot", "OpSurrender" }, new[]{ "Op" }, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Weedwacker.Shared.Network.Proto.GCGOperationReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    public global::Weedwacker.Shared.Network.Proto.GCGOperationRedraw OpRedraw {
      get { return opCase_ == OpOneofCase.OpRedraw ? (global::Weedwacker.Shared.Network.Proto.GCGOperationRedraw) op_ : null; }
      set {
        op_ = value;
    ...
    public global::Weedwacker.Shared.Network.Proto.GCGOperationOnStageSelect OpSelectOnStage {
      get { return opCase_ == OpOneofCase.OpSelectOnStage ? (global::Weedwacker.Shared.Network.Proto.GCGOperationOnStageSelect) op_ : null; }
      set {
        op_ = value;
    ...
    public global::Weedwacker.Shared.Network.Proto.GCGOperationReroll OpReroll {
      get { return opCase_ == OpOneofCase.OpReroll ? (global::Weedwacker.Shared.Network.Proto.GCGOperationReroll) op_ : null; }
      set {
        op_ = value;
    ...
    public global::Weedwacker.Shared.Network.Proto.GCGOperationAttack OpAttack {
      get { return opCase_ == OpOneofCase.OpAttack ? (global::Weedwacker.Shared.Network.Proto.GCGOperationAttack) op_ : null; }
      set {
        op_ = value;
    ...
    public global::Weedwacker.Shared.Network.Proto.GCGOperationPass OpPass {
      get { return opCase_ == OpOneofCase.OpPass ? (global::Weedwacker.Shared.Network.Proto.GCGOperationPass) op_ : null; }
      set {
        op_ = value;
    ...
    public global::Weedwacker.Shared.Network.Proto.GCGOperationPlayCard OpPlayCard {
      get { return opCase_ == OpOneofCase.OpPlayCard ? (global::Weedwacker.Shared.Network.Proto.GCGOperationPlayCard) op_ : null; }
      set {
        op_ = value;
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Weedwacker.Shared.Network.Proto.GCGOperationReboot OpReboot {
      get { return opCase_ == OpOneofCase.OpReboot ? (global::Weedwacker.Shared.Network.Proto.GCGOperationReboot) op_ : null; }
      set {
        op_ = value;
    ...
    public global::Weedwacker.Shared.Network.Proto.GCGOperationSurrender OpSurrender {
      get { return opCase_ == OpOneofCase.OpSurrender ? (global::Weedwacker.Shared.Network.Proto.GCGOperationSurrender) op_ : null; }
      set {
        op_ = value;
    ...
    public void MergeFrom(GCGOperation other) {
      ...
      switch (other.OpCase) {
        case OpOneofCase.OpRedraw:
          if (OpRedraw == null) {
            OpRedraw = new global::Weedwacker.Shared.Network.Proto.GCGOperationRedraw();
          }
          OpRedraw.MergeFrom(other.OpRedraw);
          break;
        case OpOneofCase.OpSelectOnStage:
          if (OpSelectOnStage == null) {
            OpSelectOnStage = new global::Weedwacker.Shared.Network.Proto.GCGOperationOnStageSelect();
          }
          OpSelectOnStage.MergeFrom(other.OpSelectOnStage);
          break;
        case OpOneofCase.OpReroll:
          if (OpReroll == null) {
            OpReroll = new global::Weedwacker.Shared.Network.Proto.GCGOperationReroll();
          }
          OpReroll.MergeFrom(other.OpReroll);
          break;
        case OpOneofCase.OpAttack:
          if (OpAttack == null) {
            OpAttack = new global::Weedwacker.Shared.Network.Proto.GCGOperationAttack();
          }
          OpAttack.MergeFrom(other.OpAttack);
          break;
        case OpOneofCase.OpPass:
          if (OpPass == null) {
            OpPass = new global::Weedwacker.Shared.Network.Proto.GCGOperationPass();
          }
          OpPass.MergeFrom(other.OpPass);
          break;
        case OpOneofCase.OpPlayCard:
          if (OpPlayCard == null) {
            OpPlayCard = new global::Weedwacker.Shared.Network.Proto.GCGOperationPlayCard();
          }
          OpPlayCard.MergeFrom(other.OpPlayCard);
          break;
        case OpOneofCase.OpReboot:
          if (OpReboot == null) {
            OpReboot = new global::Weedwacker.Shared.Network.Proto.GCGOperationReboot();
          }
          OpReboot.MergeFrom(other.OpReboot);
          break;
        case OpOneofCase.OpSurrender:
          if (OpSurrender == null) {
            OpSurrender = new global::Weedwacker.Shared.Network.Proto.GCGOperationSurrender();
          }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 42: {
            global::Weedwacker.Shared.Network.Proto.GCGOperationReboot subBuilder = new global::Weedwacker.Shared.Network.Proto.GCGOperationReboot();
            if (opCase_ == OpOneofCase.OpReboot) {
